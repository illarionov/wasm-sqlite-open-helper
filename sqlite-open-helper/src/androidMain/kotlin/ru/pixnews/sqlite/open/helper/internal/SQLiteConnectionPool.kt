...
import ru.pixnews.sqlite.open.helper.common.api.xor
import ru.pixnews.sqlite.open.helper.internal.SQLiteConnectionPool.AcquiredConnectionStatus.DISCARD
import ru.pixnews.sqlite.open.helper.internal.SQLiteConnectionPool.AcquiredConnectionStatus.NORMAL
import ru.pixnews.sqlite.open.helper.internal.SQLiteConnectionPool.AcquiredConnectionStatus.RECONFIGURE
...
internal class SQLiteConnectionPool<
    ...
    private val availableNonPrimaryConnections: MutableList<SQLiteConnection<CP, SP, WP>> = mutableListOf()
    ...
    private val acquiredConnections: WeakHashMap<SQLiteConnection<CP, SP, WP>, AcquiredConnectionStatus> = WeakHashMap()
