...
public interface SqliteCallbackStore {
    ...
    public val sqlite3TraceCallbacks: MutableMap<WasmPtr<SqliteDb>, SqliteTraceCallback>
    public val sqlite3ProgressCallbacks: MutableMap<WasmPtr<SqliteDb>, SqliteProgressCallback>
