...
import ru.pixnews.wasm.sqlite.open.helper.host.linux.LinuxEmbedderHost.NativeClock
import ru.pixnews.wasm.sqlite.open.helper.host.linux.LinuxEmbedderHost.NativeCommandArgsProvider
import ru.pixnews.wasm.sqlite.open.helper.host.linux.LinuxEmbedderHost.NativeMonotonicClock
...
internal actual fun createDefaultEmbedderHost(builder: Builder): EmbedderHost = LinuxEmbedderHost(
    ...
    monotonicClock = builder.monotonicClock?: NativeMonotonicClock,
    clock = builder.clock ?: NativeClock,
