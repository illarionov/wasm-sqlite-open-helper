...
internal class GraalvmEmscriptenStackExports(
    ...
    override val emscripten_stack_get_free by mainBindings.functionMember()
    override val emscripten_stack_get_base by mainBindings.functionMember()
    override val emscripten_stack_get_end by mainBindings.functionMember()
