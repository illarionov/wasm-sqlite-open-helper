package ru.pixnews.sqlite.open.helper.graalvm.host.emscripten
...
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.Abort
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.AssertFail
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.EmscriptenDateNow
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.EmscriptenGetNow
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.EmscriptenGetNowIsMonotonic
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.EmscriptenResizeHeap
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.SyscallFchown32
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.SyscallFstat64
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.SyscallFtruncate64
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.SyscallGetcwd
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.SyscallOpenat
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.SyscallUnlinkat
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.syscallLstat64
import ru.pixnews.sqlite.open.helper.graalvm.host.emscripten.func.syscallStat64
...
import ru.pixnews.sqlite.open.helper.host.WasmValueType.WebAssemblyTypes.F64
