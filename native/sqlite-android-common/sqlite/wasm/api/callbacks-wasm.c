...
SQLITE_WASM_CB_IMPORT void ext_sqlite3_exec_cb(int, int, void *, void *);
...
SQLITE_WASM_CB_IMPORT int ext_sqlite3_comparator_call_cb(int, int, const char *, int, const char *);
SQLITE_WASM_CB_IMPORT void ext_sqlite3_comparator_destroy(int);
...
void __keep_sqlite_cb_callbacks() {
  ext_sqlite3_exec_cb(0, 0, 0, 0);
  ext_sqlite3_trace_cb(0, 0, 0, 0);
  ext_sqlite3_progress_cb(0);
  ext_sqlite3_comparator_call_cb(0, 0, 0, 0, 0);
  ext_sqlite3_comparator_destroy(0);
