...
import ru.pixnews.wasm.sqlite.open.helper.host.filesystem.posix.LinuxReadFd.callReadWrite
import ru.pixnews.wasm.sqlite.open.helper.host.filesystem.posix.base.PosixOperationHandler

internal object LinuxWriteFd : PosixOperationHandler<WriteFd, WriteError, ULong> {
