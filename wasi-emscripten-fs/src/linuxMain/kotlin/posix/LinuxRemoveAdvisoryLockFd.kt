...
import ru.pixnews.wasm.sqlite.open.helper.host.filesystem.posix.LinuxAddAdvisoryLockFd.errnoToAdvisoryLockError
import ru.pixnews.wasm.sqlite.open.helper.host.filesystem.posix.LinuxAddAdvisoryLockFd.setFromAdvisoryLock
import ru.pixnews.wasm.sqlite.open.helper.host.filesystem.posix.base.PosixOperationHandler

internal object LinuxRemoveAdvisoryLockFd : PosixOperationHandler<RemoveAdvisoryLockFd, AdvisoryLockError, Unit> {
