...
import ru.pixnews.sqlite.open.helper.gradle.graalvm.GraalvmCompilerJvmArgumentsProvider
import ru.pixnews.sqlite.open.helper.gradle.graalvm.isRunningOnGraalVm
