...
buildscript {
    ...
    dependencies {
        classpath("androidx.room:androidx.room.gradle.plugin:2.7.0-alpha07")
        classpath("com.android.tools.build:gradle:8.5.2")
        classpath("com.diffplug.spotless:spotless-plugin-gradle:7.0.0.BETA1")
        classpath("com.google.devtools.ksp:symbol-processing-gradle-plugin:2.0.20-RC2-1.0.24")
...
include("wasi-emscripten-fs")
include("wasi-emscripten-fs-test-fixtures")
